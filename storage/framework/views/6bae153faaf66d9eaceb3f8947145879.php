													...
													<div class="m-0">
														...
														<div class="d-flex d-grid gap-5">
                                                            ...
                                                            <div class="d-flex d-grid gap-5">
                                                                ...
                                                                <div class="m-0">
                                                                    <!--begin::Number-->
                                                                    <span class="text-gray-700 fw-bolder d-block fs-1 lh-1 ls-n1 mb-1"><?php echo e(App\Models\Master\Pustakawan::count()); ?></span>
                                                                    <!--end::Number-->
                                                                </div>
                                                                <!--end::Item-->
                                                            </div>
													...
													<div class="m-0">
														...
														<div class="d-flex d-grid gap-5">
                                                            ...
                                                            <div class="d-flex d-grid gap-5">
                                                                ...
                                                                <div class="m-0">
                                                                    <!--begin::Number-->
                                                                    <span class="text-gray-700 fw-bolder d-block fs-1 lh-1 ls-n1 mb-1"><?php echo e(App\Models\Absensi\Khidmah::count()); ?></span>
                                                                    <!--end::Number-->
                                                                </div>
                                                                <!--end::Item-->
                                                            </div>
													...
													<div class="m-0">
														...
														<div class="d-flex d-grid gap-5">
                                                            ...
                                                            <div class="d-flex d-grid gap-5">
                                                                ...
                                                                <div class="m-0">
                                                                    <!--begin::Number-->
                                                                    <span class="text-gray-700 fw-bolder d-block fs-1 lh-1 ls-n1 mb-1"><?php echo e(App\Models\Master\Pustakawan::count() + App\Models\Absensi\Khidmah::count()); ?></span>
                                                                    <!--end::Number-->
                                                                </div>
                                                                <!--end::Item-->
                                                            </div>
														...
														<div class="d-flex d-grid gap-5">
															...
															<div class="d-flex flex-column flex-shrink-0 me-4">
																...
																<i class="ki-duotone ki-right-square fs-6 text-gray-600 me-2">
																	<span class="path1"></span>
																	<span class="path2"></span>
																</i>Pagi : <?php echo e(App\Models\Kehadiran\AbsenPegawai::whereDate('tanggal', today())
                                                                               ->where('shift', 'Pagi')
																...
																<i class="ki-duotone ki-right-square fs-6 text-gray-600 me-2">
																	<span class="path1"></span>
																	<span class="path2"></span>
																</i>Siang : <?php echo e(App\Models\Kehadiran\AbsenPegawai::whereDate('tanggal', today())
                                                                                ->where('shift', 'Siang')
                                                                                ->where('keterangan', 'Hadir')
                                                                                ->count()); ?>
															...
															<div class="d-flex flex-column flex-shrink-0">
																...
																<i class="ki-duotone ki-right-square fs-6 text-gray-600 me-2">
																	<span class="path1"></span>
																	<span class="path2"></span>
																</i>Malam : <?php echo e(App\Models\Kehadiran\AbsenPegawai::whereDate('tanggal', today())
                                                                                ->where('shift', 'Malam')
                                                                                ->where('keterangan', 'Hadir')
                                                                                ->count()); ?>
														...
														<div class="d-flex d-grid gap-5">
                                                            ...
                                                            <div class="d-flex d-grid gap-5">
                                                                ...
                                                                <div class="m-0">
																	...
																	<?php echo e(App\Models\Kehadiran\IzinPegawai::whereDate('tgl_mulai', 'tgl_selesai', today())
																			->count()); ?>
													...
													<div class="m-0">
														...
														<div class="d-flex d-grid gap-5">
                                                            ...
                                                            <div class="d-flex d-grid gap-5">
                                                                ...
                                                                <div class="m-0">
                                                                    <!--begin::Number-->
                                                                    <span class="text-gray-700 fw-bolder d-block fs-1 lh-1 ls-n1 mb-1"> <?php echo e($tidakMasuk); ?> </span>
                                                                    <!--end::Number-->
                                                                </div>
                                                                <!--end::Item-->
                                                            </div>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/home.blade.php ENDPATH**/ ?>