				...
				<div class="row">
					<div class="col-lg-8">
                        ...
                        <?php if($berita): ?>
                            ...
                            background: url('<?php echo e(asset('storage/gambar/' . $berita->gambar)); ?>') no-repeat center;
                            ...
                            width: 100%;">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="tag d-inline-block border-30 fw-500 text-uppercase mb-15"><?php echo e($berita->penulis); ?></div>
                                        <div class="date text-dark"><span class="fw-500"><?php echo e(Carbon\Carbon::parse($berita->created_at)->isoFormat('D MMMM Y')); ?></div>
                                    </div>
                                    <div class="col-lg-7">
                                        <h3 class="block-title d-inline-block position-relative" style="background-color: rgba(255, 255, 255, 0.7); padding: 0.5rem 1rem; border-radius: 0.5rem; color: #0e3e2f;" ><a href="<?php echo e(asset('/berita-'.$berita->slug.'')); ?>"><?php echo e(Str::words($berita->judul, 10, '...')); ?></a></h3>
                                    </div>
                                </div>
                            </div>
						<!-- /.block-one -->
					...
					<div class="col-lg-4">
						...
						<div class="block-three border-30 ps-lg-4 ps-3 pe-lg-4 pe-3 pt-40 lg-pt-30 pb-30 md-mt-30 wow fadeInUp" data-wow-delay="0.2s">
							<div class="date"><?php echo e(Carbon\Carbon::parse($berita2->created_at)->isoFormat('D MMMM Y')); ?></div>
							<h3 class="block-title d-inline-block position-relative mt-20 mb-80 lg-mb-50"><a href="<?php echo e(asset('/berita-'.$berita2->slug.'')); ?>"><?php echo e($berita2->judul); ?></a></h3>
							<div class="d-flex align-items-center justify-content-between">
								<div class="tag text-uppercase fw-500"><?php echo e($berita2->penulis); ?></div>
								<a href="<?php echo e(asset('/berita-'.$berita2->slug.'')); ?>" class="round-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i class="bi bi-arrow-up-right"></i></a>
							</div>
						</div>
                        <?php endif; ?>
						<!-- /.block-three -->
                        ...
                        background: url('<?php echo e(asset('storage/gambar/' . $berita3->gambar)); ?>') no-repeat center;
                        background-size: cover;
                        height: 472px;
                        max-height: 472px;
                        width: 100%;">
							<h3 class="block-title d-inline-block position-relative mt-20 mb-250 lg-mb-150 sm-mb-100" style="background-color: rgba(255, 255, 255, 0.7); padding: 0.5rem 1rem; border-radius: 0.5rem; color: #0e3e2f;"><a href="<?php echo e(asset('/berita-'.$berita3->slug.'')); ?>"><?php echo e(Str::words($berita3->judul, 8, '...')); ?></a></h3>
							<div class="d-flex align-items-center justify-content-between">
								<div class="tag text-uppercase fw-500"><?php echo e($berita3->penulis); ?></div>
								<a href="<?php echo e(asset('/berita-'.$berita3->slug.'')); ?>" class="round-btn rounded-circle d-flex align-items-center justify-content-center tran3s"><i class="bi bi-arrow-up-right"></i></a>
							</div>
						</div>
                        <?php endif; ?>
						<!-- /.block-four -->
...
<?php echo $__env->make('layout.headerfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/welcome.blade.php ENDPATH**/ ?>