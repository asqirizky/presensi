                    ...
                    <div class="pt-6 border-0 card-header bg-success" style="background-image: url('/admin/assets/media/pattern.png'); background-size: 650px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                ...
                                <?php echo $__env->make('admin.Payroll.jabatan.jabatan_tambah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                    <!--end::Card header-->
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            <thead class="fw-bold fs-5 bg-success">
                                <tr class="text-white text-start fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-start min-w-125px">Jabatan</th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <?php $__currentLoopData = $payJabatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                    
                                <tr>
                                    <td></td>
                                    <td class="text-start">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success"><?php echo e($item->jabatan->nama_jabatan); ?></div>
                                    </td>
                                    <td></td>
                                    <td class="text-center">Rp. <?php echo e(number_format($item->tunjangan_jabatan ?? 0, 0, ',', '.')); ?></td>
                                    <td></td>
                                    ...
                                    <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="px-3 menu-item">
                                                <a href="<?php echo e(route('payroll-jabatan.hapus', $item->id)); ?>" class="px-3 menu-link delete-button">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <!--end::Menu-->
                                        <?php echo $__env->make('admin.Payroll.jabatan.edit_jabatan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/jabatan/jabatan.blade.php ENDPATH**/ ?>