    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="modal-content">
            ...
            <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
                <!--begin:Form-->
                <form class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('payroll-tunkel.update', $item->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <!--begin::Heading-->
                    <div class="text-center mb-13">
                        <!--begin::Title-->
                        <h1 class="mb-3">Edit Tunjangan Keluarga</h1>
                    ...
                    <div class="mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Col-->
                        <input type="text" class="form-control form-control-lg" name="tunkel" placeholder="Tunjangan Keluarga" value="<?php echo e($item->tunkel); ?>" required>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/tunkel/edit_tunkel.blade.php ENDPATH**/ ?>