            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Ruang</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                        ...
                        <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <div class="gap-2 d-flex justify-content-end">
                                    <!--begin::button-->
                                    <?php if(auth()->user()->hasPermissionTo('master ruang-tambah')): ?>
                                    ...
                                    <?php endif; ?>
                                    <!--end::button-->
                                    <?php echo $__env->make('admin.Master.ruang.tambah_ruang', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="px-4 py-3 badge fs-7 badge-light-primary"><?php echo e($item->ruang_pustakawans); ?> </div>
                                    </td>
                                    <td class="text-center"></td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center pe-4">
                                        <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                <?php if(auth()->user()->hasPermissionTo('master ruang-edit')): ?>
                                                ...
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <?php if(auth()->user()->hasPermissionTo('master ruang-hapus')): ?>
                                                <div class="px-3 menu-item">
                                                    <a href="<?php echo e(route('master-ruang.hapus', $item->id)); ?>" class="px-3 menu-link delete-button">Hapus</a>
                                                </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu-->
                                            <?php echo $__env->make('admin.Master.ruang.edit_ruang', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Master/ruang/ruang.blade.php ENDPATH**/ ?>