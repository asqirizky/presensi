...
<div class="modal fade" id="kt_modal_new_target<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('payroll-pengabdian.update', $item->id)); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <!--begin::Heading-->
                <div class="text-center mb-13">
                    <!--begin::Title-->
                    <h1 class="mb-3">Edit Tunjangan Pengabdian</h1>
                ...
                <div class="mb-8 fv-row text-start">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" class="form-control form-control-lg" name="tunjangan_pengabdian" placeholder="Tunjangan Pengabdian" value="<?php echo e(number_format($item->tunjangan_pengabdian ?? 0, 0, ',', '.')); ?>" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/pengabdian/edit_pengabdian.blade.php ENDPATH**/ ?>