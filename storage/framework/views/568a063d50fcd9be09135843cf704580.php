                ...
                <div class="card">
                    ...
                    <div class="pt-6 border-0 card-header bg-success" style="background-image: url('/admin/assets/media/pattern.png'); background-size: 25%; background-position: right top; background-repeat: no-repeat;">
                        ...
                        <div class="card-toolbar">
                            <div class="gap-2 d-flex justify-content-end">
                                ...
                                <?php echo $__env->make('admin.Payroll.kehormatan.tambah_kehormatan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <!--end::button-->
                            </div>
                        </div>
                        <!--end::Card toolbar-->
                    ...
                    <div class="py-4 card-body">
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <?php $__currentLoopData = $kehormatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td></td>
                                <td class="text-start">
                                    <div class="px-4 py-3 badge fs-7 badge-light-success"></div>
                                </td>
                                <td class="text-center">Rp. <?php echo e(number_format($item->tunjangan_kehormatan ?? 0, 0, ',', ',')); ?></td>
                                ...
                                <td class="text-center pe-4">
                                    <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="px-3 menu-item">
                                                <a href="<?php echo e(route('payroll-kehormatan.hapus', $item->id)); ?>" class="px-3 menu-link delete-button">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
                                        <?php echo $__env->make('admin.Payroll.kehormatan.edit_kehormatan', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <!--end::Menu-->
                                    </td>
                                </tr>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/kehormatan/kehormatan.blade.php ENDPATH**/ ?>