...
<body class="relative flex items-center justify-center min-h-screen">
  ...
  <div class="relative z-10 w-full max-w-md p-10 text-center shadow-2xl bg-white/10 backdrop-blur-md rounded-2xl">
    ...
    <!-- Form -->
    <form class="form" method="POST" action="<?php echo e(route('admin.kehadiran-absen.store')); ?>">
      <?php echo csrf_field(); ?>
      <!-- Input NIK -->
      <div>
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Absen/absen_biasa.blade.php ENDPATH**/ ?>