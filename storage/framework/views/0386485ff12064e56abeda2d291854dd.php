                        ...
                        <div class="card-toolbar">
                            <div class="flex-wrap gap-3 d-flex justify-content-between align-items-end" data-kt-user-table-toolbar="base">
                                <form method="GET" class="row g-2 align-items-end">
                                    ...
                                    <div class="col-auto">
                                        <a type="submit" href="admin/kehadiran-izinBulan" class="btn btn-warning">Perbulan</a>
                                    </div>
                                </form>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Kehadiran/izin/izin_pegawai.blade.php ENDPATH**/ ?>