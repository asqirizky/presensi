...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="date" name="tmt" class="form-control form-control-lg" value="<?php echo e($pustakawan->tmt); ?>" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="date" name="tmt_mengajar" class="form-control form-control-lg" value="<?php echo e($pustakawan->tmt_mengajar); ?>">
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="date" name="tgl_khidmah" class="form-control form-control-lg" value="<?php echo e($pustakawan->tgl_khidmah); ?>">
                    <!--end::Col-->
                ...
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--begin::Col-->
                    <div class="mb-8 fv-row">
                        <select class="form-select" name="jabatan_id" value="" data-control="select2" data-hide-search="true" data-placeholder="Pilih Jabatan" required >
                ...
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" name="asrama" class="form-control form-control-lg" value="<?php echo e($pustakawan->asrama); ?>">
                    <!--end::Col-->
                    <div class="form-text">Khusus tenaga khidmah</div>
                </div>
                <!--end::Input group-->
                ...
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--begin::Col-->
                    <div class="mb-8 fv-row">
                        <select class="form-select" name="sekolah_pagi" data-control="select2" data-hide-search="true" data-placeholder="Pilih Keterangan" required >
...
<?php /**PATH /var/www/html/resources/views/admin/Master/pustakawan/pustakawan_edit.blade.php ENDPATH**/ ?>