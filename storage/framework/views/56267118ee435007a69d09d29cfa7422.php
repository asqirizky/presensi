    ...
    <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Data Pegawai</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card">
                    <!--begin::Card header-->
                    <div class="pt-6 border-0 card-header bg-success bgi-no-repeat" style="background-image:url('admin/assets//media/pattern.png'); background-size: 650px; background-position: right; background-repeat: no-repeat;">
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            <div class="flex-wrap gap-3 d-flex justify-content-between align-items-end" data-kt-user-table-toolbar="base">
                                <?php if(auth()->user()->hasPermissionTo('kehadiran pegawai-tambah')): ?>
                                <a href=<?php echo e(route('kehadiran.tambah-pegawai')); ?> type="button" class="btn btn-primary">
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            <thead class="fw-bold fs-5 bg-success">
                                <tr class="text-white text-start fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-center min-w-80px"></th>
                                    <th class="text-center min-w-80px">TMT</th>
                                    <th></th>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="overflow-hidden symbol symbol-circle symbol-50px me-3">
                                            <div class="symbol-label">
                                                <img src="<?php echo e(asset('storage/pegawai/' . $item->foto)); ?>" class="w-100" />
                                            </div>
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::User details-->
                                        <div class="d-flex flex-column">
                                            <div class="mb-1 text-gray-800"><?php echo e($item->nama_pegawai); ?></div>
                                        </div>
                                        <!--begin::User details-->
                                    </td>
                                    <td class="text-center"></td>
                                    <td class="text-center"><?php echo e(Carbon\Carbon::parse($item->tmt )->isoFormat('dddd, D MMMM Y')); ?></td>
                                    <td></td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center pe-4">
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            <?php if(auth()->user()->hasPermissionTo('kehadiran pegawai-detail')): ?>
                                                <!--begin::Menu item-->
                                                <div class="px-3 menu-item">
                                                    <a class="px-3 menu-link" href="<?php echo e(url('admin/kehadiran-detail_pegawai=' . $item->id)); ?>">Detail</a>
                                                </div>
                                                <!--end::Menu item-->
                                            <?php endif; ?>
                                            <?php if(auth()->user()->hasPermissionTo('kehadiran pegawai-hapus')): ?>
                                            <!--begin::Menu item-->
                                            <div class="px-3 menu-item">
                                                <a href="<?php echo e(route('kehadiran-pegawai.hapus', $item->id)); ?>" class="px-3 menu-link delete-button" data-kt-users-table-filter="delete_row" data-confirm-delete="true">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <?php endif; ?>
                                        </div>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/Kehadiran/pegawai/pegawai.blade.php ENDPATH**/ ?>