...
<div class="modal fade" id="kt_modal_update_permission<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
                <!--begin::Form-->
                <form class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('pengguna-akses.update', $item->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3"><?php echo e($item->name); ?></h1>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control" placeholder="Nama Akses" name="name" value="<?php echo e($item->name); ?>" required/>
                        <!--end::Input-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control" placeholder="Nama Kategori Kategori" name="category" value="<?php echo e($item->category); ?>" required/>
                        <!--end::Input-->
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/user/permission/edit.blade.php ENDPATH**/ ?>