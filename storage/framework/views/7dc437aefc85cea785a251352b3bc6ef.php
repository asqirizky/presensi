...
<div class="modal fade" id="kt_modal_new_target<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('payroll-rankDosen.update', $item->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-8 fv-row text-start">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" class="form-control form-control-lg" name="tahun" placeholder="Tahun Ke" value="<?php echo e($item->tahun); ?>" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row text-start">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" class="form-control form-control-lg" name="pendidikan_terakhir" placeholder="Pendidikan Terakhir" value="<?php echo e($item->pendidikan_terakhir); ?>" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row text-start">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" class="form-control form-control-lg" name="t_rank_dosen" placeholder="Rank Dosen" value="<?php echo e(number_format($item->t_rank_dosen ?? 0, 0, ',', ',')); ?>" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/rank_dosen/edit_rank.blade.php ENDPATH**/ ?>