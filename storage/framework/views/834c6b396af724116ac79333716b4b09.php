...
<div class="modal fade" id="kt_modal_update_details<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('pengguna.update', $item->id)); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>
                <!--begin::Heading-->
                <div class="mb-13 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Edit Data Pengguna</h1>
                    <div class="text-muted fw-semibold fs-5">Edit data; <?php echo e($item->name); ?> </div>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                ...
                <div class="text-center fv-row mb-7">
                    ...
                    <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                        ...
                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url(<?php echo e(asset('/storage/foto/' . $item->foto)); ?>);"></div>
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="name" id="name" class="form-control mb-3 mb-lg-0" placeholder="Nama Pengguna" value="<?php echo e($item->name); ?>" required autocomplete="name" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="idstaf" id="idstaf" class="form-control mb-3 mb-lg-0" placeholder="ID Staff" value="<?php echo e($item->idstaf); ?>" required autocomplete="idstaf" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="jabatan" id="jabatan" class="form-control mb-3 mb-lg-0" placeholder="Jabatan Instansi" value="<?php echo e($item->jabatan); ?>" required autocomplete="jabatan" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                ...
                <div class="fv-row mb-12">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="username" id="username" class="form-control mb-3 mb-lg-0" placeholder="Username" value="<?php echo e($item->username); ?>" required autocomplete="username" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/user/edit.blade.php ENDPATH**/ ?>