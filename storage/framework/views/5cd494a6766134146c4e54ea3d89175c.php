            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Data Hari Libur</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="pt-6 border-0 card-header bg-success" style="background-image: url('/admin/assets/media/pattern.png'); background-size: 650px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <div class="card-toolbar">
                            <form method="GET" class="d-flex align-items-center gap-3">
                                ...
                                <?php if(auth()->user()->hasPermissionTo('master libur-tambah')): ?>
                            ...
                            <?php echo $__env->make('admin.Master.libur.libur_tambah', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                    <!--end::Card header-->
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            <thead class="fw-bold fs-5 bg-success">
                                <tr class="text-white text-start fw-bold fs-7 text-uppercase gs-0">
                                    <th class="text-center rounded-start w-80px pe-2"></th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <?php $__currentLoopData = $libur; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="text-center">

                                    </td>
                                    <td class="text-center">
                                        <div class="px-4 py-3 badge fs-7 badge-light-primary"><?php echo e(Carbon\Carbon::parse($item->tanggal)->isoFormat('dddd, D MMMM Y')); ?></div>
                                    </td>
                                    <td class="text-center"></td>
                                    <td class="text-center"><?php echo e($item->ruang->ruang_pustakawans ?? '-'); ?></td>
                                    <td class="text-center"></td>
                                    <td class="text-center">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success"><?php echo e($item->libur); ?></div>
                                    </td>
                                    <td></td>
                                    <td class="text-center pe-4">
                                        <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                <?php if(auth()->user()->hasPermissionTo('master libur-edit')): ?>
                                                ...
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <?php if(auth()->user()->hasPermissionTo('master libur-hapus')): ?>
                                                    <div class="px-3 menu-item">
                                                        <a href="<?php echo e(route('master-libur.hapus', $item->id)); ?>" class="px-3 menu-link delete-button" data-kt-users-table-filter="delete_row" data-confirm-delete="true">Hapus</a>
                                                    </div>
                                                <?php endif; ?>
                                                <!--end::Menu item-->
                                            </div>
                                            <?php echo $__env->make('admin.Master.libur.libur_edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <!--end::Menu-->
                                        </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Master/libur/libur.blade.php ENDPATH**/ ?>