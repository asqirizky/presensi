                ...
                <div class="text-center fv-row mb-2">
                    ...
                    <div class="card-body d-flex flex-center flex-column">
                        ...
                        <div class="symbol symbol-125px symbol-circle mb-4">
                            <img src="<?php echo e(asset('/storage/foto/' . $item->foto)); ?>" alt="image" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Name-->
                        <a href="#" class="fs-2 text-gray-800 text-hover-primary fw-bold mb-2"><?php echo e($item->name); ?></a>
                        <!--end::Name-->
                    </div>
                    <!--end::Hint-->
                </div>
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/user/ubahpassword.blade.php ENDPATH**/ ?>