...
<div class="modal fade" id="kt_modal_new_target<?php echo e($item->id); ?>" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" enctype="multipart/form-data" action="<?php echo e(route('payroll-kehadiran.update', $item->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-8 fv-row text-start">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" class="form-control form-control-solid form-control-lg" value="<?php echo e(ucwords(strtolower($item->tempatTinggal))); ?>" placeholder="Tunjangan Kehadiran" readonly>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 fv-row text-start">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" name="tunjangan" class="form-control form-control-lg" value="<?php echo e(number_format($item->tunjangan ?? 0, 0, ',', '.')); ?>" placeholder="Tunjangan Kehadiran">
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/kehadiran/edit_kehadiran.blade.php ENDPATH**/ ?>