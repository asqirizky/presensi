                        ...
                        <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <div class="gap-2 d-flex justify-content-end">
                                    ...
                                    <?php echo $__env->make('admin.Payroll.tunkel.tambah_tunkel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <!--end::button-->
                                </div>
                            </div>
                            <!--end::Card toolbar-->
                    ...
                    <div class="py-4 card-body">
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <?php $__currentLoopData = $tunkel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td></td>
                                    <td class="text-center"></td>
                                    <td class="text-center">Rp. <?php echo e(number_format($item->tunkel ?? 0, 0, ',', '.')); ?></td>
                                    <td class="text-center"></td>
                                    <td class="text-center"></td>
                                    ...
                                    <td class="text-center pe-4">
                                        <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                                ...
                                                <!--begin::Menu item-->
                                                <div class="px-3 menu-item">
                                                    <a href="<?php echo e(route('payroll-tunkel.hapus', $item->id)); ?>" class="px-3 menu-link delete-button">Hapus</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <?php echo $__env->make('admin.Payroll.tunkel.edit_tunkel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            <!--end::Menu-->
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layout.sidebarnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/tunkel/tunkel.blade.php ENDPATH**/ ?>