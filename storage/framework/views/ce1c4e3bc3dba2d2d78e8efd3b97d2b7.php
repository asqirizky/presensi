...
<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" enctype="multipart/form-data" action="admin/payroll-pengabdian">
                <?php echo csrf_field(); ?>
                <!--begin::Heading-->
                ...
                <div class="mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" class="form-control form-control-lg" name="tunjangan_pengabdian" placeholder="Tunjangan Pengabdian" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
...
<?php /**PATH /home/yogy/Dokumen/presensi/resources/views/admin/Payroll/pengabdian/tambah_pengabdian.blade.php ENDPATH**/ ?>