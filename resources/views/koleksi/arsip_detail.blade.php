				...
				<div class="row">
					<div class="col-lg-5 order-lg-2">
						<div class="tab-content product-img-tab-content h-100">
							<div class="tab-pane fade show active h-100" id="img1" role="tabpanel">
								<a class="fancybox w-100 h-100 d-flex align-items-center justify-content-center" data-fancybox="" href="{{ asset('/storage/koleksi/arsip/' . $arsip->gambar) }}" tabindex="-1">
									<img src="assets/images/lazy.svg" data-src="{{ asset('/storage/koleksi/arsip/' . $arsip->gambar) }}" alt="" class="lazy-img">
								</a>
							</div>
						</div>
					</div>
					<div class="col-lg-6 order-lg-3">
						<div class="product-info ps-xxl-5 md-mt-40">
							<div class="stock-tag">Arsip</div>
							<h2 class="product-name fw-bold">{{ $arsip->judul }}</h2>
							<div class="row mt-40">
								<div class="col-xl-6">
									<h5>Tipe</h5>
								</div>
								<div class="col-xl-6">
                                    <h5 class="fw-bold">: @if($arsip->tipe == null) Belum diketahui @else {{ $arsip->tipe }} @endif</h5>
								</div>
							</div>
							<div class="row mt-10">
								<div class="col-xl-6">
								...
								<div class="col-xl-6">
                                    <h5 class="fw-bold">:
                                        @if($arsip->pembuat == null) Belum diketahui @else {{ $arsip->pembuat }} @endif
                                    </h5>
								</div>
							</div>
							<div class="row mt-10">
								...
								<div class="col-xl-6">
                                    <h5 class="fw-bold">:
                                        @if($arsip->tanggal == null) Belum diketahui @else
                                        {{ Carbon\Carbon::parse($arsip->tanggal)->isoFormat('D MMMM Y') }}
                                        @endif
                                    </h5>
								</div>
							</div>
							<div class="row mt-10">
								...
								<div class="col-xl-6">
                                    <h5 class="fw-bold">: {{ Carbon\Carbon::parse($arsip->created_at)->isoFormat('D MMMM Y') }}</h5>
								</div>
							</div>
							<div class="row mt-10">
								<div class="col-xl-6">
								...
								<div class="col-xl-6">
                                    <h5 class="fw-bold">: @if($arsip->lembaga == null) Belum diketahui @else {{ $arsip->lembaga }} @endif</h5>
								</div>
							</div>
						</div> <!-- /.product-info -->
					</div>
