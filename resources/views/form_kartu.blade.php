								...
								<div class="col-xxl-12">
                                    ...
                                    <div class="card card-flush pb-0 bgi-position-y-center bgi-no-repeat mb-10" style="background-size: auto calc(100% + 10rem); background-position-x: 100%; background-image: url('kegiatan/media/perpustakaan/banner-masjid.png')">
                                        ...
                                        <div class="card-body pt-7 pb-7">
                                            <!--begin:Form-->
                                            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="{{ asset('pelayanankartu=simpan') }}">
                                                @csrf
                                                <!--begin::Heading-->
                                                <div class="mb-8 text-center">
                                                    ...
                                                    @endphp
                                                    @if(request()->is('pelayanankartu=putra'))
                                                    <h1 class="mb-3">Form Pelayanan Pembuatan Kartu Anggota - Putra</h1>
                                                    @elseif(request()->is('pelayanankartu=putra'))
                                                    <h1 class="mb-3">Form Pelayanan Pembuatan Kartu Anggota - Putri</h1>
                                                    @endif
                                                    @if($hour >= 13 && $hour < 17)
                                                ...
                                                @elseif(request()->is('pelayanankartu=putri'))
                                                ...
                                                <div class="fv-row mb-8">
                                                    ...
                                                    <select class="form-select" name="kategori" data-control="select2" data-hide-search="true" data-placeholder="Pilih Kategori Cetak">
                                                        <option>Pilih kategori cetak</option>
