...
<body>
    ...
    <div class="login-card">
        ...
        <div class="form-group">
            ...
            <input type="text" placeholder="Username" name="username" class="form-control form-control-lg @error('username') is-invalid @enderror" required autocomplete="username" autofocus />
        ...
        <div class="form-group">
            ...
            <input type="password" placeholder="Password" class="form-control form-control-lg @error('password') is-invalid @enderror" name="password" id="password" required autocomplete="current-password" />
