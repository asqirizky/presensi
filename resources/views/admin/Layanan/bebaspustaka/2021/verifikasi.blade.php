				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-md-650px py-5">
                        ...
                        <div class="card-body py-15 py-lg-20">
                            ...
                            <!--end::Title-->
                            <!--begin::Text-->
                            <div class="fw-semibold fs-6 text-gray-500 mb-7">Anda telah menverifikasi Surat Keterangan Bebas Pustaka milik {{ $plagiasi->mahasiswa->nama }}.</div>
                            <!--end::Text-->
                            <!--begin::Illustration-->
                            {{-- <div class="mb-0">
                            ...
                            <!--end::Link-->
                            <div class="mb-0">
                                <a href="{{ asset('ketbebaspustaka='.$plagiasi->id.'') }}" class="btn btn-sm btn-light-warning me-2">Lihat Surat</a>
                            </div>
                        </div>
                        @else
                        <div class="card-body py-15 py-lg-20">
                            <form method="POST" enctype="multipart/form-data" action="{{ asset('/layanan-ketbebaspustaka/'.$plagiasi->id.'/verifikasi') }}">
                                @csrf
                                <!--begin::Logo-->
                                ...
                                <!--end::Title-->
                                <!--begin::Text-->
                                <div class="fw-semibold fs-6 text-gray-500 mb-7">Mahasiswa atas nama {{ $plagiasi->mahasiswa->nama }} saat ini sedang menunggu verifikasi tanda tangan elektronik untuk Surat Keterangan Bebas Pustaka.</div>
                                <!--end::Text-->
                                <!--begin::Illustration-->
                                {{-- <div class="mb-0">
                                    <img src="admin/assets/media/auth/welcome.png" class="mw-100 mh-300px theme-light-show" alt="" />
