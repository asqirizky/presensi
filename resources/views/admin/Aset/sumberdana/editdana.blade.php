    ...
    <div class="modal-dialog modal-dialog-centered mw-700px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <!--begin:Form-->
                <form class="text-start" id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="{{ route('aset-sumber.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Heading-->
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Edit Sumber Dana</h1>
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="sumberdana" id="sumberdana" class="form-control mb-3 mb-lg-0" value="{{ $item->sumberdana }}" placeholder="Sumber Dana" required="" autocomplete="sumberdana">
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
