...
<div class="modal fade" id="kt_modal_tambah_unit" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-700px">
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 psb-15">
            <!--begin:Form-->
            <form class="text-start" method="POST" enctype="multipart/form-data" action="{{ route('unit.store', $aset->id) }}">
            @csrf
                <!--begin::Heading-->
                <div class="mb-13 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Tambah Unit</h1>
                    <div class="text-muted fw-semibold fs-5">{{ $aset->nama }}</a>.</div>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                <div class="fv-row mb-8">
                    <!--begin::Label-->
                    <label class="required fw-semibold fs-6 mb-2 ">Jumlah Unit</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" name="jumlah" id="jumlah" min="1" value="1" placeholder="Jumlah Unit" class="form-control mb-3 mb-lg-0" required>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="date" name="tanggal" class="form-control mb-3 mb-lg-0" required>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="number" name="harga" id="harga" min="1000" value="1000" class="form-control mb-3 mb-lg-0" required>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="nb" class="form-control mb-3 mb-lg-0" placeholder="Nomor Bukti/Kwitansi">
                    <!--end::Input-->
                </div>
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    <!--begin::Label-->
                    <label class="required fw-semibold fs-6 mb-2 ">Upload Kwitansi</label>
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="file" name="kwitansi" class="form-control mb-3 mb-lg-0" placeholder="Kwitansi">
                    <!--end::Input-->
                ...
                <div class="fv-row mb-14">
                    ...
                    <div class="me-4 image-input image-input-outline image-input-placeholder image-input-empty" data-kt-image-input="true">
                        ...
                        <label
                            ...
                            <!--begin::Inputs-->
                            <input type="file" name="foto" value="blank.png" accept=".png, .jpg, .jpeg">
