...
<div class="modal fade" id="kt_modal_tambah" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-700px">
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="/admin/aset">
                @csrf
                <!--begin::Heading-->
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="nama" class="form-control mb-3 mb-lg-0" placeholder="Nama Barang" required>
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
