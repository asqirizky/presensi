    ...
    <div class="modal-dialog modal-dialog-centered mw-700px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 psb-15">
                <!--begin:Form-->
                <form class="text-start" method="POST" enctype="multipart/form-data" action="/admin/aset-pemeliharaan/store">
                @csrf
                    <!--begin::Heading-->
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Pemeliharaan" data-kt-autosize="true"></textarea>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="petugas" placeholder="Petugas Pemeliharaan" class="form-control mb-3 mb-lg-0" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="fv-row mb-14">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="number" name="biaya" min="1000" value="1000" class="form-control mb-3 mb-lg-0" required>
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
