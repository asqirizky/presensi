...
<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-700px">
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="/admin/aset-kategori">
                @csrf
                <!--begin::Heading-->
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="kategori" id="kategori" class="form-control mb-3 mb-lg-0" placeholder="Nama Kategori Barang" required="" autocomplete="kategori">
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="kode" id="kode" class="form-control mb-3 mb-lg-0" placeholder="Kode Kategori" required="" autocomplete="kode">
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-15">
                    ...
                    <select id="jenis" name="jenis" class="form-select" data-control="select2" data-placeholder="Pilih Jenis Kategori" data-hide-search="true" required autocomplete="jenis">
                        ...
                        <option value="Barang Kendaraan">Kendaraan & Mesin</option>
                        <option value="Elekronik">Inv. Elekronik</option>
                        <option value="Mebeler">Inv. Mebeler</option>
                        <option value="Perlangkapan">Inv. Perlangkapan</option>
