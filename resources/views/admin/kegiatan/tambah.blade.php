...
<div class="modal fade" id="kt_modal_add" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-600px">
        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="/admin/kegiatan"">
                @csrf
                <!--begin::Heading-->
                <div class="mb-8 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Tambah Kegiatan</h1>
                    <div class="text-muted fw-semibold fs-5">Tambahkan rencana kegiatan Perpustakaan Ibrahimy.</div>
                    <!--end::Title-->
                </div>
                <div class="fv-row mb-8">
                    ...
                    <input type="text" name="kegiatan" id="kegiatan" class="form-control mb-3 mb-lg-0" placeholder="Nama Kegiatan" required autocomplete="kegiatan">
                    <!--end::Image input-->
                    <!--begin::Hint-->
                ...
                <div class="fv-row mb-8">
                    ...
                    <!--end::Label-->
                    <!--begin::Image placeholder-->
                    <input type="date" name="tanggal" id="tanggal" class="form-control mb-3 mb-lg-0" required autocomplete="tanggal">
                    <!--end::Image input-->
                </div>
                <div class="fv-row mb-14">
                    ...
                    <!--end::Label-->
                    <!--begin::Image placeholder-->
                    <select class="form-select" name="pj" id="pj" data-control="select2" data-hide-search="true" data-placeholder="Pilih Penanggung Jawab">
                        <option></option>
