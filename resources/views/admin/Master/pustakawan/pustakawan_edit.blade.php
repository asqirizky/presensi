        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('master-pustakawan.update', $pustakawan->id) }}">
                ...
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="date" name="tmt" class="form-control form-control-lg" value="{{ $pustakawan->tmt }}" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="date" name="tmt_mengajar" class="form-control form-control-lg" value="{{ $pustakawan->tmt_mengajar }}">
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="date" name="tgl_khidmah" class="form-control form-control-lg" value="{{ $pustakawan->tgl_khidmah }}">
                    <!--end::Col-->
                ...
                <div class="mb-8 text-start fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" name="asrama" class="form-control form-control-lg" value="{{ $pustakawan->asrama }}">
                    <!--end::Col-->
                    <div class="form-text">Khusus tenaga khidmah</div>
                </div>
                <!--end::Input group-->
