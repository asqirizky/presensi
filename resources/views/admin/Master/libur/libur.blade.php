                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $item->ruang->ruang_pustakawans ?? '-' }}</td>
                                    <td class="text-center"></td>
                                    <td class="text-center">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success">{{ $item->libur }}</div>
                                    </td>
                                    <td></td>
                                    <td class="text-center pe-4">
                                        <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                @if (auth()->user()->hasPermissionTo('master libur-edit'))
                                                ...
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                @if (auth()->user()->hasPermissionTo('master libur-hapus'))
                                                    <div class="px-3 menu-item">
                                                        <a href="{{ route('master-libur.hapus', $item->id) }}" class="px-3 menu-link delete-button" data-kt-users-table-filter="delete_row" data-confirm-delete="true">Hapus</a>
                                                    </div>
                                                @endif
                                                <!--end::Menu item-->
                                            </div>
                                            @include('admin.Master.libur.libur_edit')
                                            <!--end::Menu-->
                                        </td>
                                    </tr>
                                    @endforeach
