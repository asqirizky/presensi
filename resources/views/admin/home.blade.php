                            ...
                            <div class="col-xl-6 mb-5 mb-xl-10">
                                ...
                                <div id="kt_sliders_widget_2_slider" class="card card-flush carousel carousel-custom carousel-stretch slide h-xl-100" data-bs-ride="carousel" data-bs-interval="5500">
                                    ...
                                    <div class="card-header pt-5">
                                        <!--begin::Title-->
                                        <h4 class="card-title d-flex align-items-start flex-column">
                                            <span class="card-label fw-bold text-gray-800">Layanan Perpustakaan</span>
                                            <span class="text-gray-500 mt-1 fw-bold fs-7">Statistik layanan ditampilkan di sini</span>
                                        </h4>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                        <div class="card-toolbar">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active show">
                                                ...
                                                <div class="d-flex align-items-center mb-9">
                                                    ...
                                                    <div class="symbol symbol-70px symbol-circle me-5">
                                                        <span class="symbol-label bg-light-success">
                                                            <i class="ki-outline ki-credit-cart fs-3x text-success"></i>
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Info-->
                                                    <div class="m-0">
                                                        <!--begin::Subtitle-->
                                                        <h4 class="fw-bold text-gray-800 mb-3">Kartu Anggota({{ Carbon\Carbon::now()->isoFormat('MMMM Y') }})</h4>
                                                        <!--end::Subtitle-->
                                                        <!--begin::Items-->
                                                        <div class="d-flex d-grid gap-5">
                                                            <!--begin::Item-->
                                                            <div class="d-flex flex-column flex-shrink-0 me-4">
                                                                ...
                                                                <span class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2">
                                                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i>{{ \App\Models\Layanan\Layanan_kartu::where('kategori', "Anggota Baru")
                                                                ...
                                                                <!--begin::Section-->
                                                                <span class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2">
                                                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i>{{ \App\Models\Layanan\Layanan_kartu::where('kategori', "Perpanjang/Cetak Ulang")
                                                                    ->whereMonth('created_at', \Carbon\Carbon::now()->month)
                                                                    ->whereYear('created_at', \Carbon\Carbon::now()->year)
                                                                    ->count() }} Cetak Ulang
                                                                </span>
                                                            ...
                                                            <div class="d-flex flex-column flex-shrink-0">
                                                                ...
                                                                <!--begin::Section-->
                                                                <span class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2">
                                                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i>{{ \App\Models\Layanan\Layanan_kartu::where('kategori', "Mahasiswa Baru")
                                                                    ->whereMonth('created_at', \Carbon\Carbon::now()->month)
                                                                    ->whereYear('created_at', \Carbon\Carbon::now()->year)
                                                                    ->count() }} Mahasiswa Baru
                                                                </span>
                                                                <!--end::Section-->
                                                                <!--begin::Section-->
                                                                <span class="d-flex align-items-center fs-7 fw-bold text-gray-500 mb-2">
                                                                    <i class="ki-outline ki-right-square fs-6 text-gray-600 me-2"></i>{{ \App\Models\Layanan\Layanan_kartu::where('ket', "Selesai")
                                                                    ->whereMonth('created_at', \Carbon\Carbon::now()->month)
                                                                    ->whereYear('created_at', \Carbon\Carbon::now()->year)
                                                                    ->count() }} Kartu Tercetak
                                                                </span>
                                                                <!--end::Section-->
                                                            </div>
                                                            <!--end::Item-->
                                            ...
                                            <div class="carousel-item">
                                                <div class="d-flex align-items-center mb-9">
                                                    ...
                                                    <div class="symbol symbol-70px symbol-circle me-5">
                                                        <span class="symbol-label bg-light-success">
                                                            <i class="ki-outline ki-teacher fs-3x text-success"></i>
                                                        </span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Info-->
                                                    <div class="m-0">
                                                        <!--begin::Subtitle-->
                                                        <h4 class="fw-bold text-gray-800 mb-3">Bebas Pustaka</h4>
                                                        <!--end::Subtitle-->
                                                        <!--begin::Items-->
                                                        <div class="d-flex d-grid gap-5">
                                                            <!--begin::Item-->
                                                            <div class="m-0">
                                                                <!--begin::Number-->
                                                                <span class="text-gray-700 fw-bolder d-block fs-1 lh-1 ls-n1 mb-1">{{ App\Models\Layanan\Layanan_bebastanggungan::count() }}</span>
                                                                <!--end::Number-->
