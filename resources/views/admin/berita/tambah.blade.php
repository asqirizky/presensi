...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <!--begin::KONTEN-->
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" enctype="multipart/form-data" action="/admin/berita"">
                    @csrf
                    <!--begin::Aside column-->
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" name="judul" class="form-control mb-2" placeholder="Judul Berita" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div>
                                                ...
                                                <!--end::Label-->
                                                <textarea class="form-control @error('content') is-invalid @enderror" name="isi" id="isi"></textarea>
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                        <!--end::Card header-->
