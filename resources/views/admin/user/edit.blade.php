        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            ...
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="{{ route('pengguna.update', $item->id) }}">
                ...
                <div class="mb-13 text-center">
                    ...
                    <div class="text-muted fw-semibold fs-5">Edit data; {{ $item->name }} </div>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                ...
                <div class="text-center fv-row mb-7">
                    ...
                    <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                        ...
                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('/storage/foto/' . $item->foto) }});"></div>
                ...
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="name" id="name" class="form-control mb-3 mb-lg-0" placeholder="Nama Pengguna" value="{{ $item->name }}" required autocomplete="name" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="idstaf" id="idstaf" class="form-control mb-3 mb-lg-0" placeholder="ID Staff" value="{{ $item->idstaf }}" required autocomplete="idstaf" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-7">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="jabatan" id="jabatan" class="form-control mb-3 mb-lg-0" placeholder="Jabatan Instansi" value="{{ $item->jabatan }}" required autocomplete="jabatan" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                ...
                <div class="fv-row mb-12">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <input type="text" name="username" id="username" class="form-control mb-3 mb-lg-0" placeholder="Username" value="{{ $item->username }}" required autocomplete="username" />
                    <!--end::Input-->
                </div>
                <!--end::Input group-->
