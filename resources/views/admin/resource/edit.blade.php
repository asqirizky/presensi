...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Edit Resource Guide Prodi {{ $resource->prodi }}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <!--begin::KONTEN-->
                <!--begin::Form-->
                <form class="form d-flex flex-column flex-lg-row" method="POST" enctype="multipart/form-data" action="{{ route('resource.update', $resource->id) }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Main column-->
                    <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <select name="prodi" class="form-select mb-2" data-control="select2" data-hide-search="false" data-placeholder="Pilih Program Studi" id="kt_ecommerce_add_product_status_select">
                                                <option value="{{ $resource->prodi }}">{{ $resource->prodi }}</option>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div>
                                                ...
                                                <!--end::Label-->
                                                <textarea class="form-control @error('content') is-invalid @enderror" name="resource" id="resource">{{ $resource->resource }}</textarea>
                                            </div>
                                            <!--end::Input group-->
                                        </div>
                                        <!--end::Card header-->
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="/admin/resource" class="btn btn-light me-5">Cancel</a>
                            <!--end::Button-->
                            <!--begin::Button-->
