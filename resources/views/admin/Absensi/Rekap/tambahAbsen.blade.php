...
<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="{{ route('rekap-absen.store') }}">
                @csrf
                <!--begin::Heading-->
                ...
                <div class="mb-8 fv-row text-start">
                    ...
                    <div class="mb-8 fv-row">
                        <select class="form-select" name="nik" data-control="select2" data-hide-search="true" data-placeholder="Pilih Khidmah" required autocomplete="lokasi">
                            <option value="" selected disabled>Pilih Khidmah</option>
                ...
                <div class="mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="date" class="form-control form-control-lg" name="tanggal" placeholder="Tanggal Mulai" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
