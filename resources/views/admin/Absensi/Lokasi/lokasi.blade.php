        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Data Lokasi Absen</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control w-250px ps-12" placeholder="Cari Lokasi" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--end::Card title-->
                         ...
                         <div class="card-toolbar">
                            <!--begin::Select-->
                            @if(auth()->user()->hasPermissionTo('absen lokasi-tambah'))
                            <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">
                                <i class="ki-outline ki-plus fs-2"></i>Tambah Lokasi
                            </button>
                            <!--end::Select-->
                            @include('admin.Absensi.Lokasi.tambah_lokasi')
                            @endif
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_category_table">
                            <thead class="fw-bold fs-5 bg-info">
                                <tr class="text-start text-white fw-bold fs-7 text-uppercase gs-0">
                                    <th class="ps-6 rounded-start min-w-100px">Lokasi</th>
                                    <th></th>
                                    <th>Kode</th>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <div class="text-gray-800 fs-5 fw-bold mb-1">{{ $item->lokasi }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td></td>
                                    <td>
                                        <div class="badge px-3 py-4 fs-7 badge-light-info">{{ $item->kode_lokasi }}</div>
                                    </td>
                                    <td class="text-end pe-4">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <!--begin::Menu item-->
                                            @if(auth()->user()->hasPermissionTo('absen lokasi-edit'))
                                            ...
                                            <!--begin::Menu item-->
                                            <!--end::Menu item-->
                                            @if(auth()->user()->hasPermissionTo('absen lokasi-hapus'))
                                            <div class="menu-item px-3">
                                                <a href="{{ asset('/admin/absensi-lokasi('.$item->id.')/hapus') }}" class="menu-link px-3 delete-button">Hapus</a>
                                            </div>
                                            @endif
                                            <!--end::Menu item-->
                                        </div>
                                    ...
                                    @include('admin.Absensi.Lokasi.edit_lokasi')
                                </tr>
                                @endforeach
                            </tbody>
                            <!--end::Table body-->
