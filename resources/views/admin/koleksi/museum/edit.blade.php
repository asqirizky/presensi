        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Edit Museum</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="admin/koleksi-museum" class="text-muted text-hover-primary">Museum</a>
                        </li>
                        <!--end::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('admin/assets/media/santri/bg2.png" data-bs-theme="light">
                        ...
                        <h3 class="card-title align-items-start flex-column text-white pt-15">
                            <span class="fw-bold fs-2x mb-3">{{ $museum->judul }}</span>
                        ...
                        <div class="mt-n20 position-relative">
                            ...
                            <div class="bg-gray-100 bg-opacity-70 rounded-2 px-2 py-5">
                                ...
                                <div class="card-body py-3">
                                    ...
                                    <form class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" method="POST" enctype="multipart/form-data" action="{{ route('koleksi-museum.update', $museum->id) }}" data-select2-id="select2-data-kt_account_profile_details_form">
                                        @csrf
                                        @method('PUT')
                                        <!--begin::Card body-->
                                        <div class="card-body border-top p-9">
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <div class="col-lg-8 fv-row">
                                                    ...
                                                    <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                        ...
                                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset('/storage/koleksi/museum/' . $museum->gambar) }});"></div>
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <input type="text" name="judul" value="{{ $museum->judul }}" class="form-control mb-3 mb-lg-0" placeholder="Judul museum" required>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <input type="text" name="tipe" value="{{ $museum->tipe }}" class="form-control mb-3 mb-lg-0" placeholder="Tipe museum">
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <input type="text" name="pembuat" value="{{ $museum->pembuat }}" class="form-control mb-3 mb-lg-0" placeholder="Pembuat">
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <input type="date" name="tanggal" value="{{ $museum->tanggal }}" class="form-control mb-3 mb-lg-0" placeholder="Tanggal">
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <input type="lembaga" name="lembaga" value="{{ $museum->lembaga }}" class="form-control mb-3 mb-lg-0" placeholder="Lembaga Penanggung Jawab">
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                            ...
                                            <div class="row mb-6">
                                                ...
                                                <!--begin::Col-->
                                                <div class="col-lg-8 fv-row">
                                                    <textarea class="form-control @error('content') is-invalid @enderror" name="deskripsi" id="deskripsi">{{ $museum->deskripsi }}</textarea>
                                                </div>
                                                <!--end::Col-->
                                            </div>
                                            <!--end::Input group-->
                                        ...
                                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                                            <a href="/admin/koleksi-museum" class="btn btn-light btn-active-light-primary me-2">Cancel</a>
