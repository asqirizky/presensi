        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Data Galeri</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Data Galeri</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('admin/assets/media/santri/bg.png" data-bs-theme="light">
                        ...
                        <h3 class="card-title align-items-start flex-column text-white pt-15">
                            <span class="fw-bold fs-2x mb-3">Galeri</span>
                                ...
                                <div class="card-header border-0">
                                    <div class="card-title">
                                        ...
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <input type="text" data-kt-ecommerce-product-filter="search" class="form-control w-250px ps-12" placeholder="Cari Galeri" />
                                        </div>
                                        <!--end::Search-->
                                    </div>
                                    <!--end::Card title-->
                                    <!--begin::Card toolbar-->
                                    @if(auth()->user()->hasPermissionTo('koleksi galeri-tambah'))
                                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                        <!--begin::Add product-->
                                        <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#kt_modal_tambah">
                                            <i class="ki-outline ki-plus fs-2"></i>Tambah
                                        </button>
                                        <!--end::Add product-->
                                    </div>
                                    @endif
                                    @include('admin.koleksi.galeri.tambah')
                                </div>
                                <!--begin::Body-->
                                        ...
                                        <table class="table align-middle table-row-dashed gs-0 gy-4" id="kt_ecommerce_products_table">
                                            ...
                                            <thead>
                                                <tr class="fw-bold text-white bg-success">
                                                    <th class="ps-4 rounded-start">Galeri</th>
                                                    <th></th>
                                                    <th>Tipe</th>
                                                    <th>Pembuat</th>
                                                    <th></th>
                                                ...
                                                <tr>
                                                    <td class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-50px overflow-hidden me-3">
                                                            <div class="symbol-label">
                                                                <img src="{{ asset('/storage/koleksi/galeri/' . $item->gambar) }}" alt="{{ $item->judul }}" class="w-100" />
                                                            </div>
                                                        </div>
                                                        <!--end::Gambar-->
                                                        <!--begin::User details-->
                                                    ...
                                                    <td class="text-end pe-4">
                                                        ...
                                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                            ...
                                                            <!--begin::Menu item-->
                                                            <!--end::Menu item-->
                                                            @if(auth()->user()->hasPermissionTo('koleksi galeri-edit'))
                                                            <div class="menu-item px-3">
                                                                <a href="{{ asset('/admin/koleksi-galeri='. $item->id) }}" class="menu-link px-3">Edit</a>
                                                            </div>
                                                            @endif
                                                            <!--end::Menu item-->
                                                            <!--begin::Menu item-->
                                                            @if(auth()->user()->hasPermissionTo('koleksi galeri-hapus'))
                                                            <div class="menu-item px-3">
                                                                <a href="{{ asset('/admin/koleksi-galeri/'.$item->id.'/hapus') }}" data-url="" class="menu-link px-3 delete-button">Hapus</a>
                                                            </div>
                                                            @endif
                                                            <!--end::Menu item-->
                                                        </div>
