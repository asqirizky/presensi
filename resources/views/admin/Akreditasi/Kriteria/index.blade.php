                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-ecommerce-category-filter="search" class="form-control form-control w-250px ps-12" placeholder="Cari Instrumen Penilaian" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--end::Card title-->
                        <!--begin::Card toolbar-->
                        @if(auth()->user()->hasPermissionTo('kriteria akreditasi-tambah'))
                        <div class="card-toolbar">
                            ...
                            <!--end::Select-->
                            @include('admin.Akreditasi.Kriteria.tambah')
                        </div>
                        @endif
                        <!--end::Card toolbar-->
                    </div>
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_category_table">
                            <thead class="fw-bold fs-5 bg-info">
                                <tr class="text-start text-white fw-bold fs-7 text-uppercase gs-0">
                                    <th class="ps-6 rounded-start min-w-100px">Point</th>
                                    <th>Komponen</th>
                                    <th>Kategori</th>
                                ...
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex">
                                            <div class="position-relative ps-6 pe-3 py-2">
                                                ...
                                                <div class="text-gray-800 fs-5 fw-bold mb-1">{{ $item->point }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>{{ $item->komponen }}</td>
                                    <td><div class="badge pe-3 py-4 badge-light-info fs-7">{{ $item->kategori }}</div></td>
                                    <td class="text-end pe-4">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            <!--begin::Menu item-->
                                            <!--begin::Menu item-->
                                            @if(auth()->user()->hasPermissionTo('kriteria akreditasi-edit'))
                                            ...
                                            <!--begin::Menu item-->
                                            <!--end::Menu item-->
                                            @if(auth()->user()->hasPermissionTo('kriteria akreditasi-hapus'))
                                            <div class="menu-item px-3">
                                                <a href="{{ asset('/admin/akreditasi-kriteria('.$item->id.')/hapus') }}" class="menu-link px-3 delete-button">Hapus</a>
                                            </div>
                                            @endif
                                            <!--end::Menu item-->
                                        </div>
                                    ...
                                    @include('admin.Akreditasi.Kriteria.edit')
                                </tr>
                                @endforeach
                            </tbody>
                            <!--end::Table body-->
