...
<div class="modal fade" id="kt_modal_tambah" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="modal-body scroll-y px-15 px-lg-15 pt-0 pb-15">
            <!--begin:Form-->
            <form id="kt_modal_update_details" class="form" method="POST" enctype="multipart/form-data" action="/admin/prodi">
                @csrf
                <!--begin::Heading-->
                <div class="mb-13 text-center">
                    <!--begin::Title-->
                    <h1 class="mb-3">Tambah Program Studi</h1>
                    <div class="text-muted fw-semibold fs-5">Universitas Ibrahimy</div>
                    <!--end::Title-->
                </div>
                <!--end::Heading-->
                <!--begin::Input group-->
                <div class="fv-row mb-8">
                    ...
                    <input type="text" name="prodi" class="form-control mb-3 mb-lg-0" placeholder="Masukkan Nama Program Studi" required>
                    <!--end::Image input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                <div class="fv-row mb-8">
                    ...
                    <!--end::Label-->
                    <!--begin::Image placeholder-->
                    <input type="text" name="kode" class="form-control mb-3 mb-lg-0" placeholder="Masukkan Kode Program Studi" required>
                    <!--end::Image input-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                ...
                <div class="fv-row mb-12">
                    ...
                    <!--end::Label-->
                    <!--begin::Image placeholder-->
                    <input type="text" name="kontak" class="form-control mb-3 mb-lg-0" placeholder="Masukkan Kontak Program Studi">
                    <!--end::Image input-->
                </div>
                <!--end::Input group-->
