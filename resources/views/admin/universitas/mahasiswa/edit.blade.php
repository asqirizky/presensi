        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">{{ $mahasiswa->nama }}</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="admin/mahasiswa" class="text-muted text-hover-primary">Mahasiswa</a>
                        </li>
                        <!--end::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">{{ $mahasiswa->nama }}</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
			...
			<div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card mb-5 mb-xl-10" data-select2-id="select2-data-134-nbkd">
                    ...
                    <div id="kt_account_settings_profile_details" class="collapse show" data-select2-id="select2-data-kt_account_settings_profile_details">
                        <!--begin::Form-->
                        <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" method="POST" enctype="multipart/form-data" action="{{ route('mahasiswa.update', $mahasiswa->id) }}" data-select2-id="select2-data-kt_account_profile_details_form">
                            @csrf
                            @method('PUT')
                            <!--begin::Card body-->
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="nim" value="{{ $mahasiswa->nim }}" class="form-control mb-3 mb-lg-0" placeholder="Nomor Induk Mahasiswa" required autocomplete="nim">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="nama" value="{{ $mahasiswa->nama }}" class="form-control mb-3 mb-lg-0" placeholder="Nama Mahasiswa" required autocomplete="nama">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="kecamatan" value="{{ $mahasiswa->kecamatan }}" class="form-control mb-3 mb-lg-0" placeholder="Nama Kecamatan Asal" required autocomplete="kecamatan">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="kabupaten" value="{{ $mahasiswa->kabupaten }}" class="form-control mb-3 mb-lg-0" placeholder="Nama Kabupaten/Kota Asal" required autocomplete="kabupaten">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="row mb-14">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <input type="text" name="provinsi" value="{{ $mahasiswa->provinsi }}" class="form-control mb-3 mb-lg-0" placeholder="Nama Provinsi/Asal" required autocomplete="provinsi">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                <!--end::Input group-->
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <a href="/admin/mahasiswa" class="btn btn-light btn-active-light-primary me-2">Cancel</a>
