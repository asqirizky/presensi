                        ...
                        <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <div class="gap-2 d-flex justify-content-end">
                                    ...
                                    <!--end::Menu-->
                                    @if(auth()->user()->hasPermissionTo('kehadiran tunjangan-tambah'))
                                    <!--begin::button-->
                                ...
                                @include('admin.Kehadiran.tunjangan.kehadiran.tb_kehadiran')
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                    <!--end::Card header-->
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    <td></td>
                                    <td class="text-start">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success">{{ ucwords(strtolower($item->tempatTinggal)) }}</div>
                                    </td>
                                    <td></td>
                                    <td class="text-center">Rp. {{ number_format($item->tunjangan ?? 0, 0, ',', '.') }}</td>
                                    <td></td>
                                    ...
                                    <td class="text-center pe-4">
                                        <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                @if(auth()->user()->hasPermissionTo('kehadiran tunjangan-edit'))
                                                <div class="px-3 menu-item">
                                                ...
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                @if(auth()->user()->hasPermissionTo('kehadiran tunjangan-hapus'))
                                                <div class="px-3 menu-item">
                                                    <a href="{{ route('kehadiran-tunjangan.hapus', $item->id) }}" class="px-3 menu-link delete-button">Hapus</a>
                                                </div>
                                                @endif
                                                <!--end::Menu item-->
                                            </div>
                                            @include('admin.Kehadiran.tunjangan.kehadiran.edit_kehadiran')
                                            <!--end::Menu-->
                                        </td>
                                    </tr>
                                @endforeach
