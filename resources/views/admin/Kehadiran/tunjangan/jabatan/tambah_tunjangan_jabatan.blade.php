...
<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" enctype="multipart/form-data" action="admin/kehadiran-tunjangan-jabatan">
                @csrf
                <!--begin::Heading-->
                ...
                <!--begin::Input group-->
                    <div class="mb-8 fv-row">
                        ...
                        <!--begin::Col-->
                        <div class="mb-8 fv-row">
                            <select class="mb-2 form-select" name="nama_jabatan" data-control="select2" data-hide-search="true">
