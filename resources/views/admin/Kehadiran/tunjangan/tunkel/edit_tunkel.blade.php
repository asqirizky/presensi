    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="modal-content">
            ...
            <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
                <!--begin:Form-->
                <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('kehadiran-tunjangan-tunkel.update', $item->id) }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Heading-->
                    ...
                    <div class="mb-8 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Col-->
                        <input type="text" class="form-control form-control-lg" name="tunkel" placeholder="Tunjangan Keluarga" value="{{ $item->tunkel }}" required>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
