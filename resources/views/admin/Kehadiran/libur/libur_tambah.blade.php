...
<div class="modal fade" id="kt_modal_update_details" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
            <!--begin:Form-->
            <form class="form" method="POST" enctype="multipart/form-data" action="admin/kehadiran-libur">
                @csrf
                <!--begin::Heading-->
                ...
                <div class="mb-8 text-start fv-row">
                    ...
                    <div class="mb-8 fv-row">
                        <select class="form-select" name="ruang" value="" data-control="select2" data-hide-search="true" data-placeholder="Pilih Keterangan" required >
                            <option value="Perpustakaan Putra">Perpustakaan Putra</option>
                            <option value="Perpustakaan Putri">Perpustakaan Putri</option>
                ...
                <div class="mb-8 fv-row">
                    ...
                    <!--end::Label-->
                    <!--begin::Col-->
                    <input type="text" class="form-control form-control-lg" name="acara" placeholder="Acara" required>
                    <!--end::Col-->
                </div>
                <!--end::Input group-->
                <!--begin::Input group-->
                    ...
                    <div class="mt-3 d-flex align-items-center">
                        @foreach ( $jadwals as $item )
                            <label class="form-check form-check-custom form-check-inline me-3">
                                <input type="checkbox" class="form-check-input" name="jadwals[]" value="{{ $item->id }}">
