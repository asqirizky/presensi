                    ...
                    <div class="pt-6 border-0 card-header bg-success" style="background-image: url('/admin/assets/media/pattern.png'); background-size: 650px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <div class="card-toolbar">
                            <form method="GET" class="d-flex align-items-center gap-3">
                                ...
                                @if (auth()->user()->hasPermissionTo('kehadiran libur-tambah'))
                            ...
                            @include('admin.Kehadiran.libur.libur_tambah')
                        </div>
                        <!--end::Card toolbar-->
                    </div>
                    <!--end::Card header-->
                        ...
                        <table class="table align-middle table-striped fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="px-4 py-3 badge fs-7 badge-light-primary">{{ Carbon\Carbon::parse($item->tanggal)->isoFormat('dddd, D MMMM Y') }}</div>
                                    </td>
                                    <td class="text-center"></td>
                                    <td class="text-center">{{ $item->ruang }}</td>
                                    <td class="text-center"></td>
                                    <td class="text-center">
                                        <div class="px-4 py-3 badge fs-7 badge-light-success">{{ $item->acara }}</div>
                                    </td>
                                    <td></td>
                                    <td class="text-center pe-4">
                                        <a href="#" class="btn btn-sm btn-light-primary btn-active-primary btn-flex btn-center" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Opsi
                                            ...
                                            <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                @if (auth()->user()->hasPermissionTo('kehadiran libur-edit'))
                                                ...
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                @if (auth()->user()->hasPermissionTo('kehadiran libur-hapus'))
                                                    <div class="px-3 menu-item">
                                                        <a href="{{ route('kehadiran-libur.hapus', $item->id) }}" class="px-3 menu-link delete-button" data-kt-users-table-filter="delete_row" data-confirm-delete="true">Hapus</a>
                                                    </div>
                                                @endif
                                                <!--end::Menu item-->
                                            </div>
                                            @include('admin.Kehadiran.libur.libur_edit')
                                            <!--end::Menu-->
                                        </td>
                                    </tr>
                                    @endforeach
