                    ...
                    <div class="pt-6 border-0 card-header bg-success bgi-no-repeat" style="background-image:url('admin/assets//media/pattern.png'); background-size: 650px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <div class="card-toolbar">
                            <div class="flex-wrap gap-3 d-flex justify-content-between align-items-end" data-kt-user-table-toolbar="base">
                                @if(auth()->user()->hasPermissionTo('kehadiran pegawai-tambah'))
                                <a href={{ route('kehadiran.tambah-pegawai') }} type="button" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex align-items-center">
                                        ...
                                        <div class="overflow-hidden symbol symbol-circle symbol-50px me-3">
                                            <div class="symbol-label">
                                                <img src="{{ asset('storage/pegawai/' . $item->foto) }}" class="w-100" />
                                            </div>
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::User details-->
                                        <div class="d-flex flex-column">
                                            <div class="mb-1 text-gray-800">{{ $item->nama_pegawai }}</div>
                                        </div>
                                        <!--begin::User details-->
                                    </td>
                                    <td class="text-center"></td>
                                    <td class="text-center">{{ Carbon\Carbon::parse($item->tmt )->isoFormat('dddd, D MMMM Y')}}</td>
                                    <td></td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-center pe-4">
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            @if(auth()->user()->hasPermissionTo('kehadiran pegawai-detail'))
                                                <!--begin::Menu item-->
                                                <div class="px-3 menu-item">
                                                    <a class="px-3 menu-link" href="{{ url('admin/kehadiran-detail_pegawai=' . $item->id) }}">Detail</a>
                                                </div>
                                                <!--end::Menu item-->
                                            @endif
                                            @if(auth()->user()->hasPermissionTo('kehadiran pegawai-hapus'))
                                            <!--begin::Menu item-->
                                            <div class="px-3 menu-item">
                                                <a href="{{ route('kehadiran-pegawai.hapus', $item->id) }}" class="px-3 menu-link delete-button" data-kt-users-table-filter="delete_row" data-confirm-delete="true">Hapus</a>
                                            </div>
                                            <!--end::Menu item-->
                                            @endif
                                        </div>
