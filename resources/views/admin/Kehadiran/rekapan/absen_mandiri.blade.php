    ...
    <div class="modal-dialog modal-dialog-centered mw-800px">
        ...
        <div class="modal-content">
            ...
            <div class="pt-0 modal-body scroll-y px-15 px-lg-15 pb-15">
                <!--begin:Form-->
                <form method="POST" action="{{ route('admin.kehadiran-edit.store') }}">
                    @csrf
                    <div class="mb-6">
                        ...
                        <div class="gap-4 mt-3 flex-warp d-flex">
                            @foreach ([
                                ...
                                <label class="form-check form-check-custom form-check-solid">
                                    <input class="form-check-input need-pegawai mode-hari" type="radio" name="mode_hari" value="{{ $key }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input id="tanggal_mulai" type="date" name="tanggal_mulai" class="form-control form-control-lg need-pegawai" value="{{ old('tanggal_mulai') }}">
                    </div>

                    <div class="mb-6">
                        <label class="required fw-semibold">Tanggal Selesai</label>
                        <input id="tanggal_selesai" type="date" name="tanggal_selesai" class="form-control form-control-lg need-pegawai" value="{{ old('tanggal_selesai') }}">
                    </div>
...
<script>
    const JADWAL_PEGAWAI = @json($jadwalPegawai);
</script>
