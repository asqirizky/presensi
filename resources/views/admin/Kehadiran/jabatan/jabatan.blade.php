                    ...
                    <div class="pt-6 border-0 card-header bg-success" style="background-image: url('/admin/assets/media/pattern.png'); background-size: 650px; background-position: right; background-repeat: no-repeat;">
                        ...
                        <div class="card-toolbar">
                            <div class="flex-wrap gap-3 d-flex justify-content-between align-items-end" data-kt-user-table-toolbar="base">
                                @if(auth()->user()->hasPermissionTo('kehadiran jabatan-tambah'))
                                ...
                                @include('admin.Kehadiran.jabatan.tambah_jabatan')
                                @endif
                            </div>
                        </div>
                        <!--end::Card toolbar-->
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pe-4">
                                        ...
                                        <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px" data-kt-menu="true">
                                            @if(auth()->user()->hasPermissionTo('kehadiran jabatan-edit'))
                                            <!--begin::Menu item-->
                                            ...
                                            @endif
                                            <!--begin::Menu item-->
                                            @if(auth()->user()->hasPermissionTo('kehadiran jabatan-hapus'))
                                            <div class="px-3 menu-item">
                                                <a href="{{ route('kehadiran-jabatan.hapus', $item->id) }}" class="px-3 menu-link delete-button">Hapus</a>
                                            </div>
                                            @endif
                                            <!--end::Menu item-->
                                        </div>
                                        @include('admin.Kehadiran.jabatan.jabatan_edit')
                                        <!--end::Menu-->
                                    </td>
                                </tr>
                                @endforeach
